 ...
 */
public class U32PositionAttribute extends PositionAttribute<Integer> {
	 ...
	 */
	public U32PositionAttribute(String name) {
	 ...
	 */
	public U32PositionAttribute(String name, NumberFormat<Integer> format) {
