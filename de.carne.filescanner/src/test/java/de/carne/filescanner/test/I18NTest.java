...
public class I18NTest {
	...
	static {
		BUNDLE_BASE_NAMES.add("de.carne.filescanner.jfx.I18N");
		BUNDLE_BASE_NAMES.add("de.carne.filescanner.jfx.session.I18N");
	}

	private static final Hashtable<String, String> FXML_RESOURCES = new Hashtable<>();

	static {
		FXML_RESOURCES.put("/de/carne/filescanner/jfx/session/Session.fxml", "de.carne.filescanner.jfx.session.I18N");
	}
